...
function addApiUi() {
  ...
  document.querySelector(".suppliers-table thead").innerHTML = "<tr><th>اسم المورد</th><th>رقم الهاتف</th><th>العنوان</th><th>الملاحظات</th><th>تاريخ الإضافة</th><th>النسخة</th><th>المبلغ المدفوع</th><th>المبلغ المتبقي</th><th>الحالة</th><th>الإجراءات</th></tr>";
